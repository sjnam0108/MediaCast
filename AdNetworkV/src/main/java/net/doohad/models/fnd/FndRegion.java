...
public class FndRegion {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "fnd_region_seq_gen")
	...
	public FndRegion(String code, String name, boolean listIncluded, HttpSession session) {
		this.code = code;
		this.name = name;

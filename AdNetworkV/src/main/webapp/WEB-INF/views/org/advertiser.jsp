...
<c:url value="/org/advertiser/create" var="createUrl" />
<c:url value="/org/advertiser/read" var="readUrl" />
<c:url value="/org/advertiser/update" var="updateUrl" />
<c:url value="/org/advertiser/destroy" var="destroyUrl" />
...
<kendo:grid name="grid" pageable="true" filterable="true" sortable="true" scrollable="true" reorderable="true" resizable="true" selectable="${value_gridSelectable}" >
	...
	<kendo:grid-columns>
		<kendo:grid-column title="수정" width="50" template="<%= editTemplate %>" />
		<kendo:grid-column title="광고주" field="name" width="150" />

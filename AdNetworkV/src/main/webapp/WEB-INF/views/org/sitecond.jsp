...
<c:url value="/org/sitecond/create" var="createUrl" />
<c:url value="/org/sitecond/update" var="updateUrl" />
<c:url value="/org/sitecond/read" var="readUrl" />
<c:url value="/org/sitecond/destroy" var="destroyUrl" />

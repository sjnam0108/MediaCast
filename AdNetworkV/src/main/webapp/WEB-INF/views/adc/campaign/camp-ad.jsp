...
<c:url value="/adc/campaign/ads/read" var="readUrl" />
...
<h4 class="pt-1 pb-3 mb-3">
	<span class="mr-1 fa-light fa-audio-description fa-fw"></span>
	${pageTitle}
	<span class="font-weight-light pl-1">광고 목록</span>
</h4>
...
<ul class="nav nav-tabs tabs-alt mb-4 mt-3">
	<li class="nav-item">
		<a class="nav-link active" href="/adc/campaign/ads/${Campaign.id}">
				...
				<kendo:dataSource-transport-read-data>
					<script>
						function additionalData(e) {
							return { reqIntValue1:  ${Campaign.id} };
						}
					</script>
				</kendo:dataSource-transport-read-data>
			...
			<div class="modal-body modal-bg-color">
				<div class="form-row">
					<div class="form-group col">
						...
						<input name="name" type="text" maxlength="100" value="${Campaign.name}" class="form-control required">
					</div>
					<div class="form-group col">
						<label class="form-label">
							캠페인

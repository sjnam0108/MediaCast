...
<c:url value="/fnd/state/create" var="createUrl" />
<c:url value="/fnd/state/read" var="readUrl" />
<c:url value="/fnd/state/update" var="updateUrl" />
<c:url value="/fnd/state/destroy" var="destroyUrl" />
...
<kendo:grid name="grid" pageable="true" filterable="true" sortable="true" scrollable="false" reorderable="true" resizable="true" selectable="${value_gridSelectable}" >
	...
	<kendo:grid-columns>
		...
		<kendo:grid-column title="시/도" field="name" />

...
<head>
    ...
    <script src="/resources/vendor/js/pace.js"></script>
  	...
  	<script src="<c:url value='/resources/vendor/js/fa63.all.min.js' />"></script>
    ...
    <script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=j8mpo9mxip&submodules=geocoder,visualization"></script>
    <script type="text/javascript" src="/resources/shared/js/MarkerClustering.js"></script>
